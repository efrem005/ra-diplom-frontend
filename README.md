[![React Diplom Frontend](https://github.com/efrem005/ra-diplom-frontend/actions/workflows/web.yml/badge.svg)](https://github.com/efrem005/ra-diplom-frontend/actions/workflows/web.yml)
## [GitHub Page](https://efrem005.github.io/ra-diplom-frontend/)
...
Опубликованный сервер [https://ra-diplom-backend.onrender.com](https://ra-diplom-backend.onrender.com/api/items), может работать с перебоями, т.к. используется бесплатный тариф `render.com`

Бэкенд размещён отдельно, его код можно найти по ссылке [GITHUB](https://github.com/efrem005/ra-diplom-backend)
