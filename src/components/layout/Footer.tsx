        ...
        <div className="col">
          <section>
            ...
            <ul className="nav flex-column">
              <li className="nav-item"><Link to="/ra-diplom-frontend/about" className="nav-link">О магазине</Link></li>
              <li className="nav-item"><Link to="/ra-diplom-frontend/catalog" className="nav-link">Каталог</Link></li>
              <li className="nav-item"><Link to="/ra-diplom-frontend/contacts" className="nav-link">Контакты</Link></li>
            </ul>
          </section>
        </div>
        <div className="col">
